/**
 * Standard NES palette in 0xAABBGGRR (little-endian RGBA in memory).
 * Source: nesdev wiki "2C02 palette" — reasonable consensus values.
 */
export const NES_PALETTE: ReadonlyArray<number> = [
  ...
  0xfffffeff, 0xffffb064, 0xffff9092, 0xffff76c6, 0xffff6af3, 0xffcc6efa, 0xff7081ff, 0xff229eea,
  0xff00bebc, 0xff00d888, 0xff30e45c, 0xff82e045, 0xffdecd48, 0xff4f4f4f, 0xff000000, 0xff000000,
  0xfffffeff, 0xffffdfc0, 0xffffd2d3, 0xffffc8e8, 0xffffc2fb, 0xffeac4fa, 0xffc5ccf7, 0xffa5d8f7,
